...
Future<void> generarPdfAuxiliarL(
      ...
      build: (pw.Context context) => [
        pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          ...
          pw.Text(
              ...
              '96.947.280-5, representado para estos efectos por don RODRIGO HERNAN ESPINOZA ASTORGA, '
              'Cédula de Identidad Nro. 14.286.378-2, ambos domiciliados en la calle JOSÉ ANANÍAS N° 651, MACUL, '
              'Ciudad de SANTIAGO, REGION METROPOLITANA, con correo electrónico corporativo wss@wss.cl y otra '
              'parte don/ña $nombres $apellidos, Cédula de Identidad Nro. $rut, nacionalidad $nacionalidad, '
              'nacido el $nacimiento estado civil $civil, con domicilio en $direccion, correo electrónico $correo se '
              'conviene el siguiente contrato de trabajo, para cuyos efectos las partes se denominarán empleador y '
          ...
          pw.Text(
              'El trabajador se compromete a desempeñar el cargo de: AUXILIAR DE LABORATORIO\n'
              'Para la División Minería de WSS, unidad Calama, ubicada en sitio 45 camino a Chiu Chiu, '
              'Barrio Industrial, Calama. Obligándose a ejecutar las labores a cabalidad indicadas en su '
              'Descriptor de Cargo, las cuales son inherentes y complementarias a lo que se indica en el '
          ...
          pw.Text(
              ...
              'imponible mensual de \$$sueldoBase.- por mes vencido en dinero efectivo, moneda nacional, '
              'siendo proporcional a los días efectivamente trabajados.\n\n'
              'BONO ASISTENCIA: La empresa pagará al trabajador un bono de asistencia mensual de \$$bonoAsistencia.- '
              'imponible. Este bono solo será cancelado bajo condiciones específicas de no inasistencia ni atrasos '
              'injustificados en el mes en curso. En caso de licencia médica, el bono será cancelado de forma proporcional '
              'a los días efectivamente trabajados.\n\n'
              'ASIGNACIÓN DE COLACIÓN: La empresa pagará al trabajador una asignación de colación de \$$colacion.- '
              'líquidos, siendo proporcional a los días efectivamente trabajados.\n\n'
              'GRATIFICACIÓN: El empleador pagará mensualmente al trabajador un 25% del total de las remuneraciones '
              'mensuales, con un tope de un doceavo de 4,75 ingresos mínimos mensuales, como gratificación legal.\n\n'
              'FORMA DE PAGO: El trabajador autoriza al empleador a depositar su remuneración líquida en cuenta '
              ...
              'El pago se realizará dentro del plazo que estipula la ley, preferentemente el día 27 de cada mes, o el día '
              'hábil anterior si este fuera sábado, domingo o festivo.\n\n'
              'HORAS EXTRAS: En caso de existir horas extras durante el turno de trabajo, la empresa pagará estos con el '
              'recargo del 50% del valor de la hora normal.\n\n'
              'IMPUESTOS: En caso que la remuneración del Trabajador exceda las 13,5 UTM, el empleador tendrá la '
              'obligación de responder por el pago del impuesto a la renta correspondiente en relación con la remuneración '
              'pagada, no pudiendo ser descontado del monto líquido acordado.\n\n'
              'LEYES SOCIALES: El empleador hará las deducciones que establecen las Leyes vigentes Art. 58 del Código del '
              'Trabajo y/o las acordadas previamente con el trabajador de las remuneraciones percibidas. Se deja constancia '
              'que el trabajador cotizará en el régimen previsional chileno, comprometiéndose el empleador a efectuar las '
              'retenciones y entregarlas a las instituciones correspondientes. Según lo indicado por el Trabajador este cotiza '
              'en AFP $afp y $salud.\n\n',
              style: pw.TextStyle(fontSize: 11),
              textAlign: pw.TextAlign.justify),
          ...
          pw.Text(
              ...
              style:
                  pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)),
          pw.Text(
              'Por mutuo acuerdo de las partes, el trabajador efectuará una jornada de trabajo comprendida en: 7 días '
          ...
          pw.Text(
              ...
              'informarle cuando detecte anomalías en su entorno de trabajo o uso fraudulento de recursos de la '
              ...
              'Radio Portátil, Notebook, Tablet y cualquier otro equipo que le sea provisto para la ejecución de su '
          ...
          pw.Text(
              ...
              'Contrato de Trabajo.\n'
              '- Producir daño al medio ambiente, ya sea por tala, quema, botar desechos o desperfectos en '
          ...
          pw.Text('NOVENO: INICIO Y DURACION DEL CONTRATO\n',
              style:
                  pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 13)),
          pw.Text(
              'Se deja expresa constancia de que el trabajador ingresa al servicio de la empresa el 16/08/2022 y que la '
              'duración del presente contrato será hasta el 31/10/2022 inclusive.\n'
              'La obligación de prestar servicios emanada del presente contrato, sólo podrá cumplirse una vez '
              'que el trabajador haya obtenido la visación de residencia correspondiente en Chile o el '
          ...
          pw.Text(
              ...
              style: pw.TextStyle(fontSize: 11),
              textAlign: pw.TextAlign.justify),
          pw.Text('== CONTRATO DEBE SER FIRMADO ANTE NOTARIO ==\n',
              style: pw.TextStyle(
                  fontWeight: pw.FontWeight.bold,
                  fontSize: 12,
  ...
  final file = File('${directory.path}/Contrato_de_Trabajo.pdf');
